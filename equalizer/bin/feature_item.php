...
if(isset($_POST['comment'])){
	...
	if(mysqli_query($con,$sqt)){
		echo "<script type='text/javascript'> alert('Your comment is added!'); window.location.href='feature_item.php?id=".$ar_id."';</script>";		
	}
}
      ...
      <div class="fixed col-lg-4 col-md-4 col-sm-4">
        ...
        <div class="latest_post">
          ...
          <div class="latest_post_container">
			...
			<?php
				$result=mysqli_query($con,'SELECT * FROM articles_tbl where category_id="4" ORDER BY `articles_tbl`.`article_date` DESC limit 4');
				while($row= mysqli_fetch_array($result)){
					$image=$row['article_photo'];
					$title=$row['article_title'];
					$story=$row['article_headline'];
        ...
        <div class="left_content">
          ...
          <div class="footer_widget wow fadeInDown">
			...
			<p id="comm">Your email address will not be published. Required fields are marked *</p>
             <form  method="post" action="feature_item.php?id=<?php echo $art_id;?>">
